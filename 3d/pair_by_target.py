...
def compare_pair(data_pair: Tuple[MoleculeDatapoint, MoleculeDatapoint]) -> Tuple[str, str, float]:
...
def pair_by_target(data_path: str,
    ...
    ones = sum(1 for pair in pairs if pair[-1] == 1.0)
    print(f'{ones} / {num_pairs} ({ones / num_pairs * 100}%) ones')
